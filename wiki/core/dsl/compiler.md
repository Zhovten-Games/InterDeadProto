...
The compiler delegates step creation to the schema factories, inserting `awaitUser`, `say`, `quest`, or `overlay` steps based on stage content. Unlock directives append a final `UnlockStep` when present on the spirit config.[^3]

[^1]: Logger injection and config validation [src/core/dsl/compiler.js#L1-L24](../../../src/core/dsl/compiler.js#L1-L24); [wiki/core/logging/NullLogger.md](../../core/logging/NullLogger.md)
[^2]: Stage/message validation and quest handling [src/core/dsl/compiler.js#L18-L40](../../../src/core/dsl/compiler.js#L18-L40)
